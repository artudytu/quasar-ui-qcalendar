...
export default defineComponent({
  name: 'QCalendarSchedulerSwitchedAxis',
  ...
  setup (props, { slots, emit, expose }) {
    ...
    const parsedColumnCount = computed(() => {
      return props.modelResources.length
    })
    ...
    function __renderHead () {
      return h('div', {
        ...
        h('div', {class: {'q-calendar-scheduler__resource': true}}),
        h('div', {class: {'q-calendar-scheduler__head--days__column': true}}, [
          h('div', {class: {'q-calendar-scheduler__head--days__weekdays': true}}, __renderHeadResources())
        ])

      ])
    }

    function __renderHeadResources (resources = undefined) {
      if (resources === undefined) {
        resources = props.modelResources
      }
      return resources.map((resource, resourceIndex) => {
        return __renderResourceRow(resource, resourceIndex)
      })
    }
    ...
    function __renderResourceRow (resource, resourceIndex) {
      ...
      const resourceRow = h('div', {
        ...
        __renderResource(resource, resourceIndex),
      ])
    ...
    function __renderHeadDays () {
      if (days.value.length === 1 && parseInt(props.columnCount, 10) > 0) {
        ...
        return days.value.map(day => {
          ...
          return h('div', {class: 'q-calendar-scheduler__resource--row'}, [
          h('div', {class: 'q-calendar-scheduler__resource'}, __renderHeadDay(day)),
          h('div', {class: 'q-calendar-scheduler__resource--days'}, [...__renderDayRow(day), slot && slot({ scope })]),
    ...
    function __renderDayRow(day, resources = undefined) {
      if (resources === undefined) {
        resources = props.modelResources
      }
      return resources.map((resource, resourceIndex) => {
        return __renderDay(day, undefined, resource, resourceIndex)
      })
